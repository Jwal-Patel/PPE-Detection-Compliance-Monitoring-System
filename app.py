...
with st.sidebar:
    ...
    st.markdown("""
    <h3 style='color: #FFFFFF; font-size: 0.9rem; font-weight: 600; margin-bottom: 1rem; letter-spacing: 0.05em;'>📍 NAVIGATION</h3>
    """, unsafe_allow_html=True)
    ...
    pages_dict = {
        ...
        "📷 Detection": "pages/3_📷_Detection.py",
        "🏢 Organizations": "pages/4_🏢_Organizations.py",
        "🔐 Account": "pages/5_🔐_Account.py",
    }
